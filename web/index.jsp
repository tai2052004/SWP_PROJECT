<%-- 
    Document   : index
    Created on : Oct 27, 2024, 3:21:09 PM
    Author     : fakesimp6996
--%>
...
<html>
    ...
    <body>
        ...
        <script>
             function pay() {
              window.location.href = "/SWP_PROJECT/vnpay_pay.jsp";
            }
            function querydr() {
              window.location.href = "/SWP_PROJECT/vnpay_querydr.jsp";
            }
             function refund() {
              window.location.href = "/SWP_PROJECT/vnpay_refund.jsp";
            }
        </script>
    </body>
</html>
