        ...
        <div class="body">
                        ...
                        <div style="
                            ...
                            <div style="display: flex; align-items: center; gap: 10px;">
                                ...
                                <button style="
                                        ...
                                        background: white;
                                        cursor: pointer;
                                        " onclick="filterUsers()">Search</button>
                            </div>
                        ...
                        <div style="
                            ...
                            <div>
                                ...
                                <div style="
                                     ...
                                     padding: 16px;
                                     border-bottom: 1px solid #eee;
                                     " class="user-row" data-user-id="<%= users.getUser_id() %>">
            ...
            <script>
                function filterUsers() {
                    ...
                    users.forEach(user => {
                        const userId = user.getAttribute('data-user-id').toLowerCase();

                        if (userId.includes(searchInput)) {
                            user.style.visibility = "visible"; // Show matching row
                            user.style.height = ""; // Reset height if previously set to zero
                            visibleOrderCount++; // Increment counter for matching orders

                        } else {
                            user.style.visibility = "hidden"; // Hide non-matching row but keep layout
                            user.style.height = "0"; // Set height to zero to avoid extra space
                        }
                    });
